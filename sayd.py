...
#الدات تحت تطوير قدر تعبي ولاتنشرها الي يسوه وميسوى يعدل حقوق وينشر ويبيع  اني كنسان لاطلب من شخص ولا ريد من شخص فلوس ومابيع ادوات خلي ناس تستفاد

#نخابرك مره ثانيه 
print('\033[1;37mᯓᯓᯓᯓ➩المبرمجᯓᯓᯓᯓᯓᯓ @N_C_P ᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓ')
import datetime
#import pytz

#end_datetime = datetime.datetime(2024, 6, 30, 12, 0, 0) #
...
token= input('''
  \x1b[1;97m  \033[33mToken \x1b[1;97m: \x1b[1;92m''')
...
Hesion = [
    ...
    'Mozilla/5.0 (iPad; U; CPU OS 4_3_5 like Mac OS X; en-us) AppleWebKit/533.17.9 (KHTML, like Gecko) Version/5.0.2 Mobile/8L1 Safari/6533.18.5',
    'Mozilla/5.0 (iPad; U; CPU OS 4_3_3 like Mac OS X; en-us) AppleWebKit/533.17.9 (KHTML, like Gecko) Mobile/8J2',
    'Mozilla/5.0 (iPhone; U; CPU iPhone OS 4_3_3 like Mac OS X; en-us) AppleWebKit533.17.9 (KHTML, like Gecko) Mobile/8J2']
token2 = ""
ID2 =''
ugen2 = [
    'Mozilla/5.0 (iPhone; U; CPU iPhone OS 4_3_5 like Mac OS X; en-us) AppleWebKit/533.17.9 (KHTML, like Gecko) Version/5.0.2 Mobile/8L1 Safari/6533.18.5',
...
''')
    ...
    print(b+'1- من ايديات (اصدقاء)')
    print(('\033[92m—'*40)+'\n• DeCoDe By DEMO | @N_C_P • | @N_9_N_6\n'+('—'*40))


    print(kk+'0- تغيير الكوكيز ')
...
للاسف سكيور جرب تفتحته بعدين
 𝐔𝐒𝐄𝐑𝐍𝐀𝐌 : {idf}\n\n❖ - 𝐏𝐀𝐒𝐒𝐖𝐑𝐃 : {pw}\n\n \n Ror𓆪‏━─────⋙\n⊊𝗕𝗬⊋ ➩ @N_C_P '''
                    ...
                    statuscp +=  f'''واحد صاد حساب سكيور
المستخدم : tg://openmessage?user_id={ID}
